...
public class Grade_02 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 배열을 선언할 때 보관할 값의 개수가 얼마인지 확실치 않을 때 배열을 빈(Blank) 크기만큼만 선언하고
		 * {};를 사용하여 값을 미리 저장하는 방법
		 * 이 방법을 사용하면, 배열의 개수가 변동될 때 배열에 저장되는 값을 추가, 삭제하므로써 자동으로 배열이 생성된다.
		 * 
		...
		*/
		...
		// 세로방향으로 5번위치, 가로방향으로 2번 위치에 값 90을 저장하라.
		score[5][2] = 90;
		
		Random rnd = new Random();
		
		
		// index 줄여서 임시로 사용하기 위한 변수 명
		for(int i = 0 ; i < stdCount ; i++) { //세로 방향
			
			for(int j = 0 ; j < subCount ; j++) { //가로 방향
				// 0,0 ~ 0,4
				// 1,0 ~ 1,4
				// ~ ~ ~ ~ ~
				// 19,0 ~ 19,4
		...
		/*
		 * 배열.length : 배열의 개수가 몇개인지 알려주는 키워드 변수, 필드변수, 맴버변수
		 * 배열의 개수가 궁금할 때 일일이 세어보지 않아도 알수 있게 해주는 키워드변수 이다.
		 */
