...
public class ScoreEx_03 {
	...
	public static void main(String[] args) {
		...
		// java 1.8이상에서는 초기화 코드(new ArrayList)에는 Generic을 생략할 수 있다.
				List<ScoreVO> score18 = new ArrayList<>();

		
		/*
		* 선언을 할때는 List를 상요해서 선언을 하고
		* 초기화를 할 때는 new ArrayList() 사용해서 생성을 한다.
		* 
		* str1과 int1은 개수가 정해지지않은 특별한 배열과 같은 존재
		* 
		* List type의 인스턴스, List type의 객체, str1 리스트라고 칭한다.
		* 
