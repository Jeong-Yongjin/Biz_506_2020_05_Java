...
public class ClassEx_10 {
	...
	public static void main(String[] args) {
		...
		/*
		 * method의 맥변수 전달
		 * 전달하고자 하는 매개변수가 몇개 안될 때는 매겨변수를 잘 못전달하여 발생하는
		 * 문제가 별로 없다.
		 * 
		 * 하지만, 매개변수의 개수가 많아지면 값이 뒤바뀔 수도 있고, 경우에 따라
		 * 누락되거나, 중복 등 잘 못 전달 될 수있다.
		 * 
		 * 이럴 때 매개변수를 담을 클래스를 만들고 인스턴스를 생성한 후 인스턴스의
		 * 맴버변수에 값을 담고 인스턴스를 매개변수로 전달하면 1개의 매개변수만으로 코드를
		 * 해결 할 수 있다.
		 * 
		 * 클래스를 만들고 인스턴스트를 생성하는 절차가 번거롭기는 하지만
