...
public class ListEx_06 {
	...
	public static void main(String[] args) {
		...
		// 알파벳 개수 : 대소문자 각 26개
		char char1 = (char)(rnd.nextInt(26) + 'A'); // A의 char 코드 값은 96
		System.out.println(char1);
		
		for(int i = 0 ; i < 100 ; i++) {
			/*
			 * 0 ~ 25까지 정수를 만들고 여기에 영문자 A의 char(ASCII) 코드 값을
			 * 더하여 'A' ~ 'Z' 중에서 임의 문자 1개를 생성하는 코드
			 */
			...
			charList.add((char)(rnd.nextInt(26) + 'A'));
				...
				// 리스트에서 리스트.size() method를 호출하면 리스트의 개수를 알수 있다.
